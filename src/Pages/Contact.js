...
const ContactForm = () => {
  return (
      ...
      <section className="w-full mt-8 flex-grow">
        <div className="container mx-auto flex flex-col md:flex-row block w-11/12 md:w-full flex flex-row flex-wrap text-left mx-auto mb-4 overflow-hidden shadow-lg">
